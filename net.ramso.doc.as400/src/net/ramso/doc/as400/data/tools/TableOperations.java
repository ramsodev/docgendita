...
public abstract class TableOperations implements ITableOperations {
	...
	public IRecordOperations[] read(String[] labels, Criteria criteria,
			Order order) throws TableOperationException {
		From from = new From(TABLE_NAME);
		return read(labels, criteria, order, from);
	}

	public IRecordOperations[] read(String[] labels, Criteria criteria,
			Order order, From from) throws TableOperationException {
