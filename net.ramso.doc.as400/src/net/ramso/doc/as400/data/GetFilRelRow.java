...
public class GetFilRelRow extends RecordOperations {
	private static String[] LABELS = { "WHREFI", "WHRELI", "WHTYPE", "WHCTLN",
			"WHCSTN" };
	...
	/**
	 * Devuelve el valor de la columna DSPDBR_WHREFI en la fila representada por
	 * este objeto.
	 */
	...
	/**
	 * Devuelve el valor de la columna DSPDBR_WHRELI en la fila representada por
	 * este objeto.
	 */
	...
	/**
	 * Devuelve el valor de la columna DSPDBR_WHTYPE en la fila representada por
	 * este objeto.
	 */
	...
	/**
	 * Devuelve el valor de la columna DSPDBR_WHCTLN en la fila representada por
	 * este objeto.
	 */
	...
	/**
	 * Devuelve el valor de la columna DSPDBR_WHCSTN en la fila representada por
	 * este objeto.
	 */
